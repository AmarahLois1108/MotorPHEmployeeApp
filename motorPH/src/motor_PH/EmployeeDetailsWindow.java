...
public class EmployeeDetailsWindow extends JFrame {
    ...
    public EmployeeDetailsWindow(String[] employeeDetails) {
        ...
        // Set cell renderer for each column in table
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            String[] employeeDetails = { /* provide employee details here */ };
            EmployeeDetailsWindow window = new EmployeeDetailsWindow(employeeDetails);
